...
public class CustomDrmSession<T extends ExoMediaCrypto> implements DrmSession<T> {
  ...
  public interface ProvisioningManager<T extends ExoMediaCrypto> {
     ...
     * <em>will</em> call {@link CustomDrmSession#onProvisionCompleted()} when provisioning has
     * completed, or {@link CustomDrmSession#onProvisionError} if provisioning fails.
     *
     * @param session The session.
     */
    void provisionRequired(CustomDrmSession<T> session);
  ...
  private static final String TAG = "CustomDrmSession";
